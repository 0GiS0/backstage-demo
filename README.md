...
az keyvault secret show --vault-name $AZURE_KEY_VAULT_NAME --name GITHUB-TOKEN --query value -o tsv
...
az keyvault secret show --vault-name $AZURE_KEY_VAULT_NAME --name GITHUB-APP-CLIENT-ID --query value -o tsv
az keyvault secret show --vault-name $AZURE_KEY_VAULT_NAME --name GITHUB-APP-CLIENT-SECRET --query value -o tsv
